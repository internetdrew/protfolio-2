...
const BlogCard = ({ post }) => {
  return (
    <div className='flex max-w-lg bg-slate-100 border-2 text-slate-900 rounded-lg py-6 px-4 justify-center duration-300 hover:shadow-xl hover:shadow-pink-600/50'>
